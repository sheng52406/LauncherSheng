...
public class LauncherModel extends BroadcastReceiver
    ...
    public void startLoader(boolean isLaunching, int synchronousBindPage, int loadFlags) {
        LogUtils.d("startLoader page" + synchronousBindPage + " loadFlags" + loadFlags);
        synchronized (mLock) {
            if (DEBUG_LOADERS) {
    ...
    private class LoaderTask implements Runnable {
        ...
        private boolean loadAndBindWorkspace() {
            LogUtils.d("loadAndBindWorkspace");
            ...
            // 绑定工作区
            LogUtils.d("isUpgradePath " + isUpgradePath);
        ...
        private void bindWorkspace(int synchronizeBindPage, final boolean isUpgradePath) {
            ...
            // 加载所有剩下的页面(如果我们加载同步,我们想推迟这个工作直到第一个渲染
            synchronized (mDeferredBindRunnables) {
                mDeferredBindRunnables.clear();
            }
